 ...
 */
@Internal
public class StreamManagerRestOptions {

	private static final String PREFIX = "streammanager.";
	...
	public static final ConfigOption<String> BIND_PORT =
		key(PREFIX + "rest.bind-port")
			.defaultValue("8520")
			.withFallbackKeys(PREFIX + REST_PORT_KEY)
	...
	public static final ConfigOption<Long> AWAIT_LEADER_TIMEOUT =
		key(PREFIX + "rest.await-leader-timeout")
	...
	public static final ConfigOption<Integer> RETRY_MAX_ATTEMPTS =
		key(PREFIX + "rest.retry.max-attempts")
			.defaultValue(20)
	...
	public static final ConfigOption<Long> CONNECTION_TIMEOUT =
		key(PREFIX + "rest.connection-timeout")
	...
	public static final ConfigOption<Long> IDLENESS_TIMEOUT =
		key(PREFIX + "rest.idleness-timeout")
	...
	public static final ConfigOption<Integer> SERVER_MAX_CONTENT_LENGTH =
		key(PREFIX + "rest.server.max-content-length")
	...
	public static final ConfigOption<Integer> CLIENT_MAX_CONTENT_LENGTH =
		key(PREFIX + "rest.client.max-content-length")
			.defaultValue(104_857_600)
	...
	public static final ConfigOption<Integer> SERVER_NUM_THREADS =
		key(PREFIX + "rest.server.numThreads")
			.defaultValue(4)
