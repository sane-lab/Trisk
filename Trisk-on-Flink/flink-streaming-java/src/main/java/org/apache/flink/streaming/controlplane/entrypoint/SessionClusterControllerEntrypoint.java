 ...
 */
public abstract class SessionClusterControllerEntrypoint extends ClusterControllerEntrypoint {

	public SessionClusterControllerEntrypoint(Configuration configuration) {
		super(configuration);
	}
