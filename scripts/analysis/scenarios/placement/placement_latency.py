...
def ReadFile():
    ...
    f = open("/home/myc/workspace/flink-related/flink-testbed-org/exp_scripts/analysis/scenarios/placement/dtree_all")
    read = f.readlines()
    for r in read:
        if r.find("endToEnd latency: ") != -1:
...
if __name__ == "__main__":
    ...
    legend_labels = ["Flink"]
    legend = False
    DrawFigure(x_axis, y_axis, legend_labels, "time(s)", "latency(ms)", "placement_latency", legend)
